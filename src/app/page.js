      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <div className={styles.ctaGroup}>
            <Link href="/contact" className="btn btn-primary" style={{ backgroundColor: "#44ff00" }}>
              Explore Our Work
        ...
        <div className="grid-container grid-3">
          ...
          <div className="glass-panel-interactive" style={{ padding: "2.5rem 2rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            <div className={styles.serviceIconWrapper} style={{ background: "rgba(236, 72, 153, 0.1)", border: "1px solid rgba(236, 72, 153, 0.25)" }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="#f472b6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="24" height="24"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/><path d="M3 12c0 1.66 4 3 9 3s9-1.34 9-3"/></svg>
            </div>
